...
public class VisionConstants {
    ...
    public static final double TAG_CAM_HIGHT = 0.230;
    public static final double TAG_CAM_ANGLE = 40;

    // Camera to Tag position relative to robot center
    public static final Translation2d ROBOT_TO_CAM = new Translation2d(0.40,0.02);
    ...
    public static final double NOTE_CAM_Y = 0;
